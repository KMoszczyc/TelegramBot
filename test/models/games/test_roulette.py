...
def test_play_exact_balance_allowed(mocker, roulette):
    ...
    mocker.patch("src.models.games.roulette.random.choice", return_value=1)
...
def test_play_red_black_outcomes(mocker, roulette, rolled_number, bet_type, should_win):
    mocker.patch("src.models.games.roulette.random.choice", return_value=rolled_number)
    bet_size = 100
...
def test_play_red_black_green_bet_wins_35x(mocker, roulette):
    mocker.patch("src.models.games.roulette.random.choice", return_value=0)
    bet_size = 10
...
def test_play_red_black_green_bet_loses_on_non_zero(mocker, roulette):
    mocker.patch("src.models.games.roulette.random.choice", return_value=5)
    bet_size = 10
...
def test_play_full_flow_lose(mocker, roulette):
    mocker.patch("src.models.games.roulette.random.choice", return_value=2)
    bet_size = 50
