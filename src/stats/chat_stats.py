...
class ChatStats:
    ...
    def __init__(self, client_api_handler):
        self.received_reactions_by_username_count_html = None
        self.given_reactions_by_username_count_html = None
        self.client_api_handler = client_api_handler
        self.metadata = stats_utils.load_metadata()

    def update(self):
        self.download_chat_history()
    ...
    def generate_reactions_df(self):
        ...
        print(chat_df['len_reactions'].sum(), chat_df['len_reaction_users'].sum())
